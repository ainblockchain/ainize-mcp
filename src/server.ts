...
export function instructionsText(ctx: Context): string {
  ...
  return [
    ...
    '',
    '1. Before you claim a knowledge helps, PROVE IT. Run `live_test` with `knowledge: []` for the bare answer and',
    '   again with the candidate. Report both answers and who verified it with what score.',
